...
# TODO 1. Если ввести любое наименование, кроме седла, то оно не выведется
#  Название детали: рама
#  Такой вещи нет
#  2. С циклами вместо использования индексов списка для обращения к значениям списка задача не будет приниматься. Проведи рефакторинг
